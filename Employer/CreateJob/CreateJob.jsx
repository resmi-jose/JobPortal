...
export default class CreateJob extends React.Component {
    ...
    loadData() {
        ...
        if (param != "" || copyJobParam != "") {
            var link = param != "" ? 'https://talenttalentmicroservice.azurewebsites.net/listing/listing/GetJobByToEdit?id=' + param
    ...
    addUpdateJob() {
        ...
        var cookies = Cookies.get('talentAuthToken');
        $.ajax({
            url: 'https://talenttalentmicroservice.azurewebsites.net/listing/listing/createUpdateJob',
            headers: {
                'Authorization': 'Bearer ' + cookies,
                'Content-Type': 'application/json'
            },
