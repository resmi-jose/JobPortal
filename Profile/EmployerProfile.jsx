...
export default class EmployeeProfile extends React.Component {
    constructor(props) {
        ...
        console.log("consructor", this.state.employerData)
    ...
    loadData() {
        ...
        $.ajax({
            url: 'https://talentprofilemicroservice.azurewebsites.net/profile/profile/getEmployerProfile',
            headers: {
            ...
            success: function (res) {
                ...
                if (res.employer) {
                    ...
                    console.log("employerData_InsideloadData", employerData)
                    console.log("employerDataName", employerData.companyContact.name)
                }
    ...
    updateWithoutSave(newData) {
        console.log("updatewithoutsavedata", this.state.employerData)
    ...
    saveData() {
        ...
        var cookies = Cookies.get('talentAuthToken');
        $.ajax({
            url: 'https://talentprofilemicroservice.azurewebsites.net/profile/profile/saveEmployerProfile',
            headers: {
                'Authorization': 'Bearer ' + cookies,
                'Content-Type': 'application/json'
            },
    ...
    render() {
        console.log("employerdata_Inside_Render", this.state.employerData)
        return (
